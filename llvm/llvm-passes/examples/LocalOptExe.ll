; ModuleID = './examples/LocalOptEx.ll'
source_filename = "./examples/LocalOptEx.c"
...
define i32 @main() #0 {
  call void @log_block_entry(i32 6029472)
...
declare void @log_block_entry(i32)
...
!5 = !{!"Homebrew clang version 20.1.1"}
